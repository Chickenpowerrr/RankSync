...
abstract class AbstractMiddleware {
    ...
    final boolean allowed(CommandSender commandSender, UUID uuid, String service, String key) {
        if(next == null) {
            ...
            return check(commandSender, uuid, service, key) && this.next.allowed(commandSender, uuid, service, key);
        }
    }

    protected abstract boolean check(CommandSender commandSender, UUID uuid, String service, String key);
}
