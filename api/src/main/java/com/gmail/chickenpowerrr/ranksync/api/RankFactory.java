 ...
 * will probably need to synchronize the ranks between multiple
 * services
 *
...
public interface RankFactory<R> {
    ...
    /**
     * Turn an internally used role into a role that is supported
     * by the RankSync API
     *
     * @param internalRole the Rank object used by the platform API, not
     *                     the RankSync API
    ...
    /**
     * Turn internally used roles into roles that are supported
     * by the RankSync API
     *
     * @param internalRoles the Rank objects used by the platform API, not
     *                      the RankSync API
     ...
     * @return the Rank object used by the platform API, not
     *         the RankSync API
     */
     ...
     * @return the Rank objects used by the platform API, not
     *         the RankSync API
     */
    Collection<R> getRolesFromNames(Collection<String> strings);

    /**
     * Turn the role supported by the RankSync API back into the
     * role that is internally used by the used API
     *
    ...
    /**
     * Turn the roles supported by the RankSync API back into the
     * roles that are internally used by the used API
     *
