...
/**
 * This Api contains almost all of the methods you'll
 * need to start with the RankSync project. Right here
 * you're able to create a BotFactory or create a new
 * Bot instance
 *
 * @since 1.0.0
