...
/**
 * This event will get called when a bot updates someones ranks
 *
...
public class BotPlayerRanksUpdateEvent implements PlayerEvent, BotEvent, CancelableEvent {
   ...
   */
  public BotPlayerRanksUpdateEvent(Player player, Bot bot, Collection<Rank> toRemove,
      Collection<Rank> toAdd) {
    this.player = player;
    this.bot = bot;
