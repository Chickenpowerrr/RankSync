...
public interface DatabaseFactory {
    ...
    /**
     * Get a new database if the requested database doesn't exist,
     * otherwise it will give the cached database instance
     *
     * @param name        the name of the database
     * @param credentials the information that is needed to establish
     *                    a connection with the database
     * @return a new database if the requested database doesn't exist,
     *         otherwise it will give the cached database instance
     */
