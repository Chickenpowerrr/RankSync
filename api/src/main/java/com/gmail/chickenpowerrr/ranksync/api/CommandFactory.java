...
/**
 * This interface manages all of the things that are
 * needed to easily control commands on the given service
 *
...
public interface CommandFactory {
    ...
    /**
     * Adds a command to be able to execute it when it's
     * called by someone
     *
