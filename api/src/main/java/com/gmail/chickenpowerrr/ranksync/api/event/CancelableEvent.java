...
/**
 * This interface can be implemented by events that can
 * be cancelled before the action actually takes place
 *
...
public interface CancelableEvent extends Event {
     ...
     *
     * @param cancelled true if this event shouldn't happen,
     *                  false if it should
     */
